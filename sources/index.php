<?php  
    ...
    $pronew = $d->rawQuery("select ten$lang, tenkhongdauvi, tenkhongdauen, motangan$lang, ngaytao, id, photo,gia,banner from #_product where type = ? and hienthi > 0 and noibat>0 order by stt asc",array('san-pham'));
