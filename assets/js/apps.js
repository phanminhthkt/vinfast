...
if($(".module-slider .flexslider").exists())
{
    $('.module-slider .flexslider').flexslider({animation: 'slide'});
    $(window).trigger('resize');
}
if($("#car-slide .flexslider").exists())
{
    $('#car-slide .flexslider').flexslider({
        animation: "slide",
        controlNav: false,
...
NN_FRAMEWORK.Form_baogia = function(){
    if($("#form-baogiatuvan").exists())
    {
        $('#form-baogiatuvan').modal('show');
    }
};
