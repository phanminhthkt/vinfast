...
<?php if($type == 'video-fotorama') {
	...
	<!-- Video Fotorama -->
	<div id="fotorama-videos" data-width="100%" data-thumbmargin="20" data-height="315" data-fit="cover" data-thumbwidth="180" data-thumbheight="100" data-allowfullscreen="false" data-nav="thumbs">
...
<?php if($type == 'messages-facebook') { ?>
	<!-- Chat Messenger 2 -->
	<div class="js-facebook-messenger-box onApp rotate bottom-right cfm rubberBand animated hidden-xs hidden-sm" data-anim="rubberBand">
