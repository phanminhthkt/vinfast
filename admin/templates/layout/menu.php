<?php $logo = $d->rawQueryOne("select id, photo from #_photo where type = ? and act = ? limit 0,1",array('logo','photo_static')); ?>
<!-- Main Sidebar -->
<aside class="main-sidebar sidebar-dark-primary elevation-4 text-sm">
    <!-- Logo -->
    <a class="brand-link" href="index.php">
        <img style="max-width: 100%;padding:0px 20px;" id="logo" src="<?=UPLOAD_PHOTO.$logo['photo']?>">
    </a>
