<?php
    /* Sản phẩm */
    $nametype = "san-pham";
    $config['product'][$nametype]['title_main'] = "Dòng xe";
    ...
    $config['product'][$nametype]['banner'] = true;
    ...
    $config['product'][$nametype]['mota_ngan'] = false;
    $config['product'][$nametype]['mota'] = false;
    $config['product'][$nametype]['mota_cke'] = false;
    $config['product'][$nametype]['noibat'] = true;
    $config['product'][$nametype]['noibat_cke'] = true;
    $config['product'][$nametype]['tongquan'] = true;
    $config['product'][$nametype]['tongquan_cke'] = true;
    ...
    $config['product'][$nametype]['width'] = 1280;
    $config['product'][$nametype]['height'] = 730;
    $config['product'][$nametype]['thumb'] = '1280x730x1';
    ...
    // $nametype = "oto-dien";
    // $config['product'][$nametype]['title_main'] = "Ô tô điện";
    ...
    // $config['product'][$nametype]['giakm'] = false;
    // $config['product'][$nametype]['mota_ngan'] = true;
    // $config['product'][$nametype]['mota'] = true;
    // $config['product'][$nametype]['mota_cke'] = true;
    // $config['product'][$nametype]['tinhnang'] = true;
    // $config['product'][$nametype]['tinhnang_cke'] = true;
    // $config['product'][$nametype]['noidung'] = true;
    // $config['product'][$nametype]['noidung_cke'] = true;
    // $config['product'][$nametype]['seo'] = true;
    // $config['product'][$nametype]['width'] = 385;
    // $config['product'][$nametype]['height'] = 300;
    // $config['product'][$nametype]['thumb'] = '385x300x1';
    // $config['product'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
?>